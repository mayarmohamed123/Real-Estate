...
function FavoriteButton({
  ...
  const { isFavorited, toggleFavorite, isLoading } =
    useFavoriteToggle(propertyId);
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className={cn(
        "p-1.5 rounded-full backdrop-blur-sm transition-all shadow-sm disabled:opacity-50",
        isFavorited
